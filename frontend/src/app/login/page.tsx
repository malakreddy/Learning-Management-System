...
import { Loader2, Mail, Lock, Eye, EyeOff, LogIn, BookOpen } from "lucide-react";
        ...
        <div className="bg-white/40 backdrop-blur-xl border border-white/40 rounded-[2.5rem] p-10 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <div className="w-16 h-16 bg-white/60 rounded-2xl border border-white/40 flex items-center justify-center mx-auto mb-6 shadow-sm">
              <LogIn className="w-8 h-8 text-[#111827]" />
            </div>
            <h1 className="text-3xl font-extrabold text-[#111827] mb-3">Sign in with email</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link href="#" className="text-sm font-bold text-[#111827] hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-600 font-medium">
              ...
              <Link href="/register" className="font-extrabold text-[#111827] hover:underline ml-1">
                Sign up
              </Link>
            </p>
          </div>
